      ...
      <div className="mx-auto max-w-5xl border-t px-6">
        ...
        <div className="mt-12 gap-4 sm:grid sm:grid-cols-2 md:mt-24">
          ...
          <div className="mt-6 sm:mt-0">
            <p>Meet the amazing team that powers the Hackathon Club. From project managers to creative minds, they're the driving force that keeps the spirit of innovation, collaboration, and community alive all year long.</p>
          </div>
        </div>
